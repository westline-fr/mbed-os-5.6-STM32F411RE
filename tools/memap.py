    ...
    def parse_object_name_gcc(self, line):
        ...
        if test_re_mbed_os_name:
            ...
            if test_re_obj_name:
                ...
                if line == 'linker stubs':
                    return '[misc]'
                else:
                    if (not line.startswith("FILL") and
                        not line.startswith("SQUAD") and
                        not line.startswith("QUAD") and
                        not line.startswith("LONG") and
                        not line.startswith("SHORT") and
                        not line.startswith("BYTE") and
